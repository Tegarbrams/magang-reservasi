...
Route::prefix('admin')->middleware(['auth', 'role:1'])->name('admin.')->group(function () {
    ...
    Route::get('/schedule-management', [AdminController::class, 'scheduleManagement'])->name('schedule-management');
    Route::get('/schedule/get-data', [AdminController::class, 'getScheduleData'])->name('schedule.get-data');
    Route::post('/schedule/toggle-block', [AdminController::class, 'toggleScheduleBlock'])->name('schedule.toggle-block');
