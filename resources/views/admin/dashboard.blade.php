    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0">
            ...
            <nav class="p-4 space-y-2">
                <a href="{{ route('admin.dashboard') }}" class="sidebar-active flex items-center gap-3 px-4 py-3 rounded-lg transition">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <div>
                                            <span class="px-3 py-1 rounded-full text-xs font-medium
                                                ...
                                                @elseif($res->status == 'confirmed') bg-green-100 text-green-800
                                                @elseif($res->status == 'completed') bg-blue-100 text-blue-800
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <a href="{{ route('admin.paket-menu') }}" class="block text-center py-3 text-yellow-600 hover:text-yellow-700 font-medium text-sm transition">
                                Kelola Semua Stok →
                            </a>
